...
public class WhatsAppService {
    ...
    public void sendGiftCard(String mobileNumber, String customerName, String bogoCode, String rewardName, String expiryDate) {
        try {
            ...
            payload.put("integrated_number", "15553255021");
    ...
    @Async
    public void sendVIPGraduationMessage(String mobileNumber, String customerName) {
        try {
            RestTemplate restTemplate = new RestTemplate();
            HttpHeaders headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
            ...
            Map<String, Object> template = new HashMap<>();
            template.put("name", "vip_graduation_funnel"); // Make sure to create this template in MSG91!
            ...
            HttpEntity<Map<String, Object>> request = new HttpEntity<>(payload, headers);
            String response = restTemplate.postForObject(WHATSAPP_API_URL, request, String.class);
            System.out.println("VIP WhatsApp MSG91 Response: " + response);
            
        } catch (Exception e) {
            System.err.println("Failed to send VIP WhatsApp message: " + e.getMessage());
            e.printStackTrace();
        }
    }
}
